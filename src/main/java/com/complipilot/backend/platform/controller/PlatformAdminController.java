...
public class PlatformAdminController {
        ...
        @Operation(summary = "List all users", description = "Platform-admin only. Returns users across the SaaS platform.", security = @SecurityRequirement(name = "bearerAuth"))
        ...
        @Operation(summary = "Get organization usage", description = "Platform-admin only. Returns plan and usage limits for an organization.", security = @SecurityRequirement(name = "bearerAuth"))
        ...
        @Operation(summary = "Update organization subscription plan", description = "Platform-admin only. Manually changes an organization's plan.", security = @SecurityRequirement(name = "bearerAuth"))
